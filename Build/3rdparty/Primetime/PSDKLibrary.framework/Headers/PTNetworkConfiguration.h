...
#pragma mark - Set/Get URL Transformer

/** @name URL Transformer */
/**
 * Sets a url transformer instance. This setter retains the instance and hence the app doesn't need to retain it.
 */
- (void)setURLTransformer:(id<PTURLTransformer>)urlTransformer;

/** @name URL Transformer */
/**
 * Returns the registered url transformer instance.
 */
- (id<PTURLTransformer>)getURLTransformer;
