...
/**
 * Raw string value of the tag. This property is used for TAG type only.
 * For example: for #EXT-OATCLS-SCTE35:ababab, content is the string value "ababab".
 * For ID3 type, the value can be retrived through PTDataKey on the timed metadata instance.
 */
